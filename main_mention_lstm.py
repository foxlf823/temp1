...
from model.mentionlstm import LSTM
...
if __name__ == "__main__":
    ...
    corpus_words = utils.parser_corpus_sent(traindocuments, devdocuments, testdocuments)
    ...
    model = LSTM(vocab, len(meshlabel_to_ix))
    ...
    if opt.pretraining:
        ...
        for epoch in range(opt.dict_iteration):
            ...
            for i in range(dict_num_iter):
                ...
                dict_batch_output = model(dict_inputs)
    ...
    for epoch in range(opt.max_epoch):
        ...
        for i in range(num_iter):
            ...
            batch_output = model(mention_inputs)
        ...
        # outPath = opt.output +"/" + str(epoch+1)
